...
public class TestAbstractSlackSessionImpl
{
    ...
    private class TestSlackSessionImpl extends AbstractSlackSessionImpl
    {
        ...
        public void connect()
        {
            ...
            users.put("userid1",new SlackUserImpl("userid1", "username1", "real", "name1", "realname1","userid1@my.mail", false,false,false,false,false,false, false,"tz","tzLabel",new Integer(0)));
            users.put("userid2",new SlackUserImpl("userid2", "username2", "real", "name2", "realname2","userid2@my.mail", false,false,false,false,false,false, false,"tz","tzLabel",new Integer(0)));
            users.put("userid3",new SlackUserImpl("userid3", "username3", "real", "name3", "realname3","userid3@my.mail", true,false,false,false,false,false, false,"tz","tzLabel",new Integer(0)));
            users.put("userid4",new SlackUserImpl("userid4", "username4", "real", "name4", "realname4","userid4@my.mail", false,false,false,false,false,false, false,"tz","tzLabel",new Integer(0)));
            users.put("userid5",new SlackUserImpl("userid5", "username5", "real", "name5", "realname4","userid5@my.mail", true,false,false,false,false,false, false,"tz","tzLabel",new Integer(0)));

            users.put("botid1",new SlackUserImpl("botid1", "botname1", "real", "bot1", "real bot name 1", null,false,false,false,false,false,false,true,"tz","tzLabel",new Integer(0)));
            users.put("botid2",new SlackUserImpl("botid2", "botname2", "real", "bot2", "real bot name 2", null,false,false,false,false,false,false,true,"tz","tzLabel",new Integer(0)));
            users.put("botid3",new SlackUserImpl("botid3", "botname3", "real", "bot3", "real bot name 3", null, true,false,false,false,false,false,true,"tz","tzLabel",new Integer(0)));
