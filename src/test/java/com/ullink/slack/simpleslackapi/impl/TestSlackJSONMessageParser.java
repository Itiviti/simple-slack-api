...
//
//    private static final String TEST_REACTION = "{\"type\":\"reaction_added\", \"reaction\":\"thumbsup\", \"item\": {\"channel\":\"TESTCHANNEL1\",\"ts\":\"1360782804.083113\"}}";
...
//                channels.put(channel4.getId(), channel3);
//            }
//
//            @Override
...
//
////    @Test
//    public void testReactionAdded() throws ParseException {
//        JSONParser parser = new JSONParser();
...
//        Assert.assertTrue(reacAdded.getChannel().getId().equals("NEWCHANNEL"));
//        Assert.assertTrue(reacAdded.getChannel().getName().equals("new channel"));
//        Assert.assertTrue(reacAdded.getChannel().getPurpose().equals("To have something new"));
//        Assert.assertTrue(reacAdded.getChannel().getTopic().equals("This channel so new it aint even old yet"));
//
////        SlackChannel channel4 = new SlackChannelImpl("NEWCHANNEL", "new channel", "To have something new", "This channel so new it aint even old yet", false);
//
...
//
////    @Test
//    public void testReactionRemoved() throws ParseException {
//        JSONParser parser = new JSONParser();
